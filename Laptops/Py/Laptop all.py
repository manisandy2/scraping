...
wb = load_workbook(r"D:\Durai\Scraping\Laptops\Scraping urls\laptop urls "+date +".xlsx")
ws = wb.active
new_wb = Workbook()
...
for r in range(2, ws.max_row+1):
    ...
    pc.vijay_sale()
    pc.reliance()
    new_wb.save(r"D:\Durai\Scraping\Laptops\Save File\Sraping Data\Scraping File\Laptop Price Lists " + date + ".xlsx")
driver.quit()
