...
wb = load_workbook(r"D:\Durai\Mobile\Urls\mobile urls "+date +".xlsx")
ws = wb.active
new_wb = Workbook()
...
new_ws.cell(row=1,column=7).value = "Reliance price"
#
for r in range(2, ws.max_row+1):
    ...
    #         new_ws.cell(row=r,column=4).value = driver.find_element_by_id("priceblock_ourprice").text[1:]
    ...
    if ws.cell(row=r, column=6).value != "N/A":
        ...
        try:
            if driver.find_element_by_id("ContentPlaceHolder1_fillprice").text != None:
                # print("Nothing")
                try:
                    print(driver.find_element_by_xpath('//*[@id="ContentPlaceHolder1_fillprice"]/div[1]/div[1]/span[2]/span').text)
                    price = driver.find_element_by_xpath('//*[@id="ContentPlaceHolder1_fillprice"]/div[1]/div[1]/span[2]/span').text
                    new_ws.cell(row=r, column=6).value = price
                except:
                    print(driver.find_element_by_xpath('//*[@id="ContentPlaceHolder1_fillprice"]/div/span[2]/span').text)
                    price = driver.find_element_by_xpath('//*[@id="ContentPlaceHolder1_fillprice"]/div/span[2]/span').text
                    new_ws.cell(row=r, column=6).value = price
        except:
            pass
    ...
    new_wb.save(r"D:\Durai\Mobile\Save Data\mobile price list " + date +".xlsx")
end_time = time.time()
