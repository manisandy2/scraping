...
wb = load_workbook(r"C:\Durai\TV\Urls\Sangeetha Tv Urls.xlsx")
ws = wb.active
...
for r in range(2,ws.max_row+1):
    if ws.cell(row=r,column=4).value != "N/A":
        ...
        price = driver.find_element_by_class_name("p-d-price")
        print(price.text)

        new_ws.cell(row=l,column=2).value = price.text
        new_wb.save(r"C:\Durai\TV\Save Data\Sangeetha Tv  "+date+".xlsx")
        l = l+1
